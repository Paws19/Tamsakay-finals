...
try {
    ...
    $stmt = $db->prepare("INSERT INTO passenger_logs_hed_tbl (user_id, location, scan_time) VALUES (?, 'HED', NOW())");
    ...
    echo '<script language="javascript">
            ...
            window.location.href = "User/waiting_room_hed.php"; // Replace with actual dashboard URL
          </script>';
