...
$qrcodeFileName = "bed_qrcode_" . time() . ".png"; // Dynamic file name
$qrcodePath = $path . $qrcodeFileName;

// Set the QR code content URL (fixed for all users)
$qrContent = "http://localhost/Tamsakay/View/Admin/qr/insert_bed.php"; // Static URL
...
$insert = "INSERT INTO qrcode_tbl_bed( qr_code_path) VALUES (?)";
