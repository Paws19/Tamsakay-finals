...
if (isset($_POST['send_code'])) {
    ...
    $query = "SELECT * FROM for_driver_registration_tbl WHERE email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $update_query = "UPDATE for_driver_registration_tbl SET verification_code = ?, verification_status = 0 WHERE email = ?";
...
if (isset($_POST['reset_password'])) {
    ...
    $query = "SELECT * FROM for_driver_registration_tbl WHERE verification_code = ?";
    $stmt = $db->prepare($query);
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row['verification_status'] == 0) { // Status 0 indicates the code is valid for use
            // Update the password
            $update_query = "UPDATE for_driver_registration_tbl 
                             SET driver_password = ?, verification_code = NULL, verification_status = 1 
...
<body>
    ...
    <div class="container">
        ...
        <form action="forgot_password_driver.php" method="POST">
        ...
        <form action="http://localhost/Tamsakay/View/Driver/forgot_password_driver.php" method="POST">
